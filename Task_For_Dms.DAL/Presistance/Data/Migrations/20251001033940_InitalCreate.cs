    ...
    public partial class InitalCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DevicePropertys", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DevicePropertys_Devices_DeviceId",
                        column: x => x.DeviceId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DevicePropertys_DeviceId",
                table: "DevicePropertys",
                column: "DeviceId");
        }
